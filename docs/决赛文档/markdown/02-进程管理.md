...
**代码片段 2-1  `TaskControlBlock` 的代表性字段**
...
**代码片段 2-2  clone 的地址空间与 fd table 选择**
...
**图 2-6  context-save 到 ready-publication 的 handoff 协议**
